...
//     tb_game_manager.setMail(req, res, next);
// });
routes.GetR('/add_ip',tb_game_manager.addIp)
// router.get('/add_ip', function(req, res, next) {
//     tb_game_manager.addIp(req, res, next);
// });
routes.GetR('/del_ip',tb_game_manager.delIp)
