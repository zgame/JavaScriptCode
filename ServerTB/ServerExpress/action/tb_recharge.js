...
//-------------------------获取充值信息----------------------------
tb_recharge.getList = function (req, res, next) {
    ...
    let sql = "SELECT * FROM player_charge_rmb where true ";
    ...
    if (starttime !== '' && endtime !== ''&& starttime!== "0-0-0 0:0:" && endtime!== "0-0-0 0:0:" ) {
        ...
        sql += "and time between '" +ztime.ToDay()+"' and '"+ ztime.Tomorrow()+"'"
