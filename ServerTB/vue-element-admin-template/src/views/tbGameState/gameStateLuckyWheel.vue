    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="Loading" border fit highlight-current-row stripe>
      ...
      <el-table-column label="游戏类型" width="90" align="center">
        <template slot-scope="scope">
          ...
          <el-tag>{{scope.row.game_type}}</el-tag>
      ...
      <el-table-column label="积分" width="200" align="center">
        <template slot-scope="scope">
          {{scope.row.score}}
        </template>
      </el-table-column>
      <!--<el-table-column label="赢Top3" width="200" align="center">-->
        ...
        <!--</template>-->
      <!--</el-table-column>-->
      <el-table-column label="UID" width="400" align="center">
        <template slot-scope="scope">
         {{scope.row.uid}}
        </template>
      </el-table-column>
...
<script>
  import { getLuckyWheelList } from '@/api/tb_game_state'
  ...
  export default {
    ...
    methods: {
      getUserList() {
        ...
        //  ------------------------获取列表------------------------------
        getLuckyWheelList(this.listQuery).then(response => {
